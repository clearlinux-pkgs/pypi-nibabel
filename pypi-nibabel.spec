...
Source0  : https://github.com/nipy/nibabel/archive/5.0.0/nibabel-5.0.0.tar.gz
...
%prep
%setup -q -n nibabel-5.0.0
cd %{_builddir}/nibabel-5.0.0
pushd ..
cp -a nibabel-5.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673282233
