...
Version  : 5.0.1
Release  : 18
URL      : https://github.com/nipy/nibabel/archive/5.0.1/nibabel-5.0.1.tar.gz
Source0  : https://github.com/nipy/nibabel/archive/5.0.1/nibabel-5.0.1.tar.gz
...
%prep
%setup -q -n nibabel-5.0.1
cd %{_builddir}/nibabel-5.0.1
pushd ..
cp -a nibabel-5.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676251485
