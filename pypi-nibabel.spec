...
Source0  : https://github.com/nipy/nibabel/archive/5.2.1/nibabel-5.2.1.tar.gz
...
%prep
%setup -q -n nibabel-5.2.1
cd %{_builddir}/nibabel-5.2.1
pushd ..
cp -a nibabel-5.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709047802
