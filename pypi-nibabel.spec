...
%prep
%setup -q -n nibabel-4.0.1
cd %{_builddir}/nibabel-4.0.1
pushd ..
cp -a nibabel-4.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655670034
...
cp %{_builddir}/nibabel-4.0.1/COPYING %{buildroot}/usr/share/package-licenses/pypi-nibabel/9c0c415abfe603c9591ab70fa55f3c0f10cab417
